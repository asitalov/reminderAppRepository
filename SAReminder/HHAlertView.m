...
- (void)configtext:(NSString *)title detail:(NSString *)detail
{
    ...
    if (_detailLabel==nil) {
        _detailLabel  = [[UILabel alloc] initWithFrame:CGRectMake(0, Simble_SIZE+Simble_TOP+HHAlertview_SIZE_TITLE_FONT+25, [self getSelfSize].width, HHAlertview_SIZE_TITLE_FONT*3)];
    }
